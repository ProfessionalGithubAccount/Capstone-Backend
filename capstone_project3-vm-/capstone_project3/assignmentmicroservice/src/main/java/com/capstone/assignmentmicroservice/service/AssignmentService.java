...
//    }
    ...
    public Assignment saveAssignment(MultipartFile file, String title,Integer id) throws IOException {
...
//    }
    ...
    public List<Map<String, Object>> getDeadlines(Integer courseId) {
        ...
        String courseServiceUrl = "http://localhost:5002/courses/" + courseId; // Assuming course service is running on localhost:5002
