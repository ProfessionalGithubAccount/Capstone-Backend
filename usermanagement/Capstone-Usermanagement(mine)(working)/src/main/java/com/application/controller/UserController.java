...
public class UserController 
{
	...
	public List<Integer> getCourseIdsByStudentId(@PathVariable Integer studentId) {
		return userService.getCourseIdsByStudentId(studentId);
	}

	@GetMapping("/teachers/{teacherId}/courses")
	public List<Integer> getCourseIdsByProfessorId(@PathVariable Integer teacherId) {
		return professorService.getCourseIdsByProfessorId(teacherId);
	}
